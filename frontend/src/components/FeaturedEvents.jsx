...
const FeaturedEvents = ({ events }) => {
  ...
  const categorizedEvents = useMemo(() => {
    ...
    const newEvents = [...events].sort((a, b) => b.id - a.id).slice(0, 6);
    ...
    <section className="featured-events-section">
      <div className="featured-container">
        <div className="featured-header">
          <h2 className="featured-title">Discover What&apos;s Happening at SSN</h2>
          <p className="featured-subtitle">Explore the most exciting events on campus</p>
        </div>
