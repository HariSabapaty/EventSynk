  ...
  const features = [
    {
      ...
      description:
        'Organize college events in minutes with customizable forms and registration fields.',
    },
    {
      id: 2,
      icon: (
      ...
      description:
        'Explore hackathons, workshops, competitions, and cultural events happening on campus.',
    },
    {
      id: 3,
      icon: (
      ...
      title: 'Track and Win',
      description:
        'View your participation history, achievements, and keep track of all your event registrations.',
    },
    {
      id: 4,
      icon: (
      ...
      title: 'Stay Notified',
      description:
        'Get instant updates on registrations, deadlines, and important event announcements.',
    },
  ];
    ...
    <section className="platform-features-section">
      <div className="platform-features-container">
        <div className="platform-features-header">
          <h2 className="platform-features-title">Why Use EventSynk?</h2>
