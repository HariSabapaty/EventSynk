              ...
              <div className="form-step">
                ...
                <div className="auto-fields-notice">
                  ...
                  <div className="notice-content">
                    <strong>Name and Email</strong> will be automatically fetched from the
                    participant&apos;s account and are always required.
                  </div>
                </div>
                ...
                <div className="default-fields-section">
                  ...
                  <p className="form-section-subtitle">
                    These are standard fields for college events. You can mark them as optional or
                    turn them off if not needed.
                  </p>
                  ...
                  <div className="default-fields-list">
                    {defaultFields.map(field => (
                      <div
                        key={field.id}
                        className={`default-field-item ${!field.enabled ? 'disabled' : ''}`}
                      >
                ...
                {fields.length === 0 && (
                  <div className="empty-fields-message">
                    ...
                    <span>
                      Click &quot;Add Custom Field&quot; below to add more fields if needed
                    </span>
                  </div>
                )}
